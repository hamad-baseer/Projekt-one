...
def app():
    ...
    high_chart.options.title.text="Average Rating by Month"
    high_chart.options.xAxis.categories=list(month_average.index)
    high_chart.options.series[0].data=list(month_average["Rating"])
    return web_page
